                ...
                \begin{enumerate}
                    ...
                    \item Determine whether the series converges or diverges.
                        \begin{enumerate}
                            ...
                            \item $ \sum_{n=1}^\infty \frac{5}{n2^n}$
                            \item $ \sum_{n=2}^\infty \frac{3\sqrt{n}}{\ln 5n}$
                            \item $ \sum_{n=1}^\infty \frac{(-2)^{n-1}}{ne^n}$
                        \end{enumerate}
                    \item Find the sum.
                        \begin{enumerate}
                            \item $ \sum_{n=1}^\infty 2\cdot \left(\frac{1}{3}\right)^{n-1}$
                            \item $ \sum_{n=1}^\infty \frac{e}{\pi^{n-1}}$
                            \item $ \sum_{n=4}^\infty \frac{9}{10^n}$
                            \item $ \sum_{n=3}^\infty \frac{5^{2n-1}}{e^{3n+3}}$
                        \end{enumerate}
                    \item Find $k$ so that $ p(n) =\frac{k\cdot2^{3n-4}}{3^{2n+3}}$ defines a probability mass function. \\  That is, find $k$ so that $ \sum_{n=0}^\infty p(n) = 1$.
                \end{enumerate}
