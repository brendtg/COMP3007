        ...
        \end{enumerate}
            ...
            \item Part 2
                ...
                \begin{center}
                    ...
                    \end{tikzpicture}
                \end{center}
                                \item If you need more practice and explanation of Riemann sums, the Riemann sum project, with solutions, is available for you to use. You do not need to turn this in.
                        ...
                        \item For each of the following, approximate the area under the function $f(x)$ using $n$ rectangles of equal width and right-hand endpoints. These problems relate closely to several problems you did in Week 1 of the course.
                            \begin{enumerate}
                                \item $\displaystyle f(x) = \frac{1}{5}x+4$ on the interval $[0,10]$ and $n=10$  \\ %\textcolor{red}{(the summation problem is $\displaystyle \sum_{j=1}^{10} \left(\frac{1}{5}j+4\right)$)}
